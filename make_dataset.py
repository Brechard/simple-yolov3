...
from src.data.external_to_raw import external_to_raw

FLAGS = flags.FLAGS

flags.DEFINE_string("db", '', "If the flag is empty then process all the dataset in constants.ALL_DATA_SETS")
